...
namespace JEM
{
    ...
    public:
        ...
        {
            return m_logger->trace(std::forward<spdlog::format_string_t<Args...>>(fmt),
        ...
        {
            return m_logger->debug(std::forward<spdlog::format_string_t<Args...>>(fmt),
                                               std::forward<Args>(args)...);
        }
        ...
        {
            return m_logger->info(std::forward<spdlog::format_string_t<Args...>>(fmt),
                                               std::forward<Args>(args)...);
        }
        ...
        {
            return m_logger->warn(std::forward<spdlog::format_string_t<Args...>>(fmt),
                                               std::forward<Args>(args)...);
        }
        ...
        {
            return m_logger->error(std::forward<spdlog::format_string_t<Args...>>(fmt),
                                               std::forward<Args>(args)...);
        }
